...
define([], function () {
    ...
    TableLayout.WIDTH = 10;

    /**
     * Retrieves the parent layout.
     */
    TableLayout.prototype.parent = function () {
        return this._parent;
    };
     ...
     */
    TableLayout.prototype.g = function (value) {
     ...
     */
    TableLayout.prototype.tableLines = function () {
        var model = this.parent().model();
        return (model !== null ? model.tableLines : []);
    };

    TableLayout.prototype.invalidate = function (x, y, w, h) {
        var self = this,
            clients = this.tableLines();

        this.layout(x, y, w, h);

        this.g().selectAll(".tableLine").data(clients, function (d) { return d.id; })
            .call(function () {
    ...
    TableLayout.prototype.layout = function (x, y, w, h) {
        var client, i, step, 
            clients = this.tableLines();
