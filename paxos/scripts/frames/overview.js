...
define(["../model/log_entry"], function (LogEntry) {
    return function (frame) {
        ...
        .after(800, function () {
            model().subtitle = '<h2><em>Paxos</em> is a algorithm for implementing distributed consensus.</h2>'
                           + model().controls.html();
            layout.invalidate();
        })
        ...
        .after(300, function () {
            ...
            model().subtitle = '<h2>However, Leaner did not participate in Paxos\' negotiation process.</h2>'
                           + model().controls.html();
            layout.invalidate();
        })
